...
var serializeChild = function serializeChild(child) {
  ...
  } else if (child != null && !Array.isArray(child) && React__default.isValidElement(child)) {
...
var renderChild = function renderChild(child, renderChange) {
  if (child != null && child.diffType != null) {
    ...
    return React__default.createElement(renderChange, {
      type: diffType,
...
var renderElement = function renderElement(serializedElement, renderChange) {
  ...
  return React__default.createElement(type, newProps);
};
...
module.exports = ReactVisualDiff;
